...
def local_search_method(numberOfElements, listOfElements, backPackSize):
    ...
    while It - BestIt <= 100:
        ...
        for i in range(numberOfElements):
            ...
            if f(solution_partial, listOfElements, capacity_rest) > valor :
                ...
                BestIt = It
                mov = i
            elif f(solution_partial, listOfElements, capacity_rest) > valorTabu:
    ...
    return result
print(local_search_method(4,[[8,5],[11,7],[6,4],[4,3]],14))