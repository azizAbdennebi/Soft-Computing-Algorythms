...
from local_search import local_search_method


class Team1:
    def __init__(self):
        self.name = "Team 1"
        self.solvingMethods = ["simulated_annealing","glouton_search","tabu_search","local_search"] # List of methods that are exactly the name of the methods used
    ...
    def local_search(self, numberOfElements, listOfElements , backPackSize):
        return tabu_search_method(numberOfElements, listOfElements , backPackSize)
